...
import echec.pattern.chess.cases.*;
import echec.pattern.chess.observer.Observateur;
import echec.pattern.chess.observer.Sujet;
import echec.pattern.chess.piece.FactoryPiece;
import echec.pattern.chess.piece.Piece;

import echec.pattern.chess.piece.pieces.Pion;
import echec.pattern.chess.piece.pieces.Roi;
import echec.pattern.chess.utils.Convertisseur;
